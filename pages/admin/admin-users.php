...
<head>
  ...
  <title>User Management — Admin — RMS</title>
  <style>
...
<div class="dashboard">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-item active" onclick="location.href='admin-users.php'">
        <span>👥</span>
  ...
  <div class="modal">
    ...
    <form method="POST" action="admin-users.php" id="createForm">
      ...
      <div class="form-group">
        ...
        <small style="color: var(--text-muted); font-size: 12px;">Minimum 8 characters</small>
      </div>
